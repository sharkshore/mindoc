...
func (m *BookResult) Converter(sessionId string) (ConvertBookResult, error) {
	...
	ebookConfig := converter.Config{
		...
		Footer:       "<p style='color:#8E8E8E;font-size:12px;'>本文档由 <a href='https://www.xinyan.com' style='text-decoration:none;color:#1abc9c;font-weight:bold;'>新颜科技文档中心</a> 创建 Copyright @2018 www.xinyan.com <span style='float:right'>- _PAGENUM_ -</span></p>",
	...
	if m.Publisher != "" {
		ebookConfig.Footer = "<p style='color:#8E8E8E;font-size:12px;'>本文档由 <span style='text-decoration:none;color:#1abc9c;font-weight:bold;'>" + "新颜科技文档中心" + "</span> 创建 Copyright @2018 www.xinyan.com <span style='float:right'>- _PAGENUM_ -</span></p>"
	}
	if m.RealName != "" {
